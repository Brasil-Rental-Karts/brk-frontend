  ...
  const loadSeasons = async () => {
    ...
    try {
      ...
      if (filteredSeasons.length > 0) {
        const activeSeason =
          filteredSeasons.find((s: any) => s.status === "em_andamento") ||
          filteredSeasons[0];
        ...
        {payload.map((entry: any, idx: number) => (
          ...
          >
            ...
            <span style={{ fontFamily: "monospace", color: "#555" }}>
              {LapTimesService.formatMsToTime(entry.value)}
            </span>
          </div>
        ))}
      </div>
        ...
        <div className="border-b border-gray-200 pb-4 mb-6 flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600 mt-1">
              Compare o desempenho dos pilotos volta a volta nas baterias do
              campeonato
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 min-h-[calc(100vh-120px)]">
          ...
          {sidebarVisible && (
            ...
            >
              ...
              >
                ...
                <CardContent
                  className={`${
                    isMobile ? "" : "h-full min-h-0 flex-1"
                  } flex flex-col`}
                >
                  {showFilters ? (
                    <>
                      ...
                      <div className="space-y-4 mb-4">
                        ...
                        <div>
                          ...
                          <Select
                            ...
                            onValueChange={(value) =>
                              setSelectedBatteryIndex(parseInt(value))
                            }
                        ...
                        {lapTimesLoading ? (
                                  ...
                                  <div className="flex items-center gap-3 flex-1 min-w-0">
                                    ...
                                    <div className="flex-1 min-w-0">
                                      <div className="font-medium text-sm text-gray-900 truncate">
                                        {lapTime.user?.name
                                          ? formatName(lapTime.user.name)
                                          : `Piloto ${lapTime.userId}`}
                                      </div>
                                      <div className="text-xs text-gray-500 flex items-center gap-2">
                                        <span>Kart {lapTime.kartNumber}</span>
                                        <span>•</span>
                                        <span>
                                          {lapTime.lapTimes.length} voltas
                                        </span>
                          ...
                          <div className="text-center py-4 text-gray-500">
                            ...
                            <div className="text-sm">
                              {!selectedCategory
                                ? "Selecione uma categoria para ver os pilotos"
                                : "Nenhum tempo volta a volta encontrado"}
                            </div>
                          </div>
                        )}
                      </div>
          ...
          {(() => {
            ...
            const shouldShowChart =
              !isMobile || (isMobile && showChartMobile && !sidebarVisible);

            const shouldShowPortraitWarning =
              isMobile &&
              isPortrait &&
              !forcarGraficoNoPortrait &&
              showChartMobile &&
              !sidebarVisible;
              ...
              return (
                <div className="w-full pt-6 px-4 flex flex-col items-center">
                  <div className="flex items-center justify-center mb-2 w-full">
                    <img
                      src="/landscape-phone.svg"
                      alt="Gire o celular"
                      className="w-14 h-14"
                    />
                  </div>
                  <div className="text-sm text-gray-500 text-center mb-4">
                    Vire o celular para ver o gráfico volta a volta
                  </div>
                  <Button
                    onClick={() => setForcarGraficoNoPortrait(true)}
                    className="mx-auto"
                  >
                    Ver assim mesmo
                  </Button>
            ...
            return (
              <div
                className={sidebarVisible ? "lg:col-span-3" : "lg:col-span-4"}
              >
                <Card
                  ref={chartCardRef}
                  className={`h-full min-h-0 flex flex-col relative ${
                    isFullscreen
                      ? "ring-2 ring-orange-500 ring-opacity-50 shadow-lg"
                      : ""
                  }`}
                >
                    ...
                    {lapTimesLoading ? (
                      <div className="flex items-center justify-center h-full">
                        ...
                        <span className="ml-2 text-gray-600">
                          Carregando tempos volta a volta...
                        </span>
                      </div>
                        ...
                        <ResponsiveContainer width="100%" height="100%">
                          <LineChart>
                            ...
                            <YAxis
                              ...
                              tickFormatter={(value) =>
                                LapTimesService.formatMsToTime(value)
                              }
                              label={{
                                value: "Tempo",
                                angle: -90,
                            ...
                            {/* Legenda dos pilotos */}
                            <Legend
                              wrapperStyle={{ marginLeft: 32, marginTop: 24 }}
                            />
                            {/* Tooltip customizado */}
                      ...
                      <div className="flex items-center justify-center h-full text-gray-500">
                        <div className="text-center">
                          ...
                          <div className="text-sm">
                            Escolha os pilotos na lateral para visualizar o
                            gráfico
                          </div>
                        </div>
                      </div>
