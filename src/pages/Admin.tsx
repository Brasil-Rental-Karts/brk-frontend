...
import {
  useAdminStats,
  usePreloadUsersCache,
  useUpdateCategoriesCache,
...
export const Admin = () => {
  ...
  useEffect(() => {
    if (preloadResult) {
      toast.success(
        `Cache atualizado com sucesso! ${preloadResult.totalUsers} usuários carregados em ${preloadResult.duration}`,
        {
          duration: 5000,
        },
      );
  ...
  useEffect(() => {
    if (categoriesResult) {
      toast.success(
        `Cache de categorias atualizado com sucesso! ${categoriesResult.totalCategories} categorias e ${categoriesResult.totalPilots} pilotos carregados em ${categoriesResult.duration}`,
        {
          duration: 5000,
        },
      );
            ...
            <>
              <div className="grid gap-3 sm:gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <Card>
                  <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                    <CardTitle className="text-xs sm:text-sm font-medium">
                      Usuários com Inscrições
                    </CardTitle>
                    <TrendingUp className="h-4 w-4 text-muted-foreground" />
                  </CardHeader>
                  <CardContent>
                    <div className="text-xl sm:text-2xl font-bold text-emerald-600">
                      {stats.totalUsersWithRegistrations}
                    </div>
                    <p className="text-xs text-muted-foreground">
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="text-xl sm:text-2xl font-bold text-green-600">
                      {stats.totalConfirmedRegistrations}
                    </div>
                    <p className="text-xs text-muted-foreground">
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="text-xl sm:text-2xl font-bold text-purple-600">
                      {stats.championshipsStats.length}
                    </div>
                    <p className="text-xs text-muted-foreground">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-xs sm:text-sm text-muted-foreground space-y-2">
                    <p>
                      <strong>Pilotos Inscritos:</strong> Todos que se
                      inscreveram no campeonato
                    </p>
                    <p>
                      <strong>Pilotos Confirmados:</strong> Pagaram tudo, pelo
                      menos uma parcela, são isentos ou têm pagamento direto
                    </p>
                    <p>
                      <strong>Pilotos Pendentes:</strong> Ainda não pagaram
                      nenhuma parcela, mas as parcelas estão pendentes
                    </p>
                    <p>
                      <strong>Pilotos Atrasados:</strong> Deixaram vencer a
                      parcela
                    </p>
                  </div>
                </CardContent>
        ...
        >
          ...
          <div className="mb-6 sm:mb-8">
            ...
            <p className="text-muted-foreground text-sm sm:text-base">
              Gerencie inscrições de pilotos e adicione etapas adicionais para
              temporadas por etapa.
            </p>
          </div>
          ...
          <Card>
            <CardHeader className="pb-4">
              ...
              <CardDescription className="text-sm">
                Crie novas inscrições com status administrativo (isento ou
                pagamento direto) para pilotos em temporadas.
              </CardDescription>
            </CardHeader>
              ...
              <div className="text-center text-muted-foreground space-y-3">
                ...
                <div>
                  ...
                  <div className="text-sm space-y-1">
                    <p>
                      <strong>Inscrição Administrativa:</strong> Use para
                      pilotos isentos ou com pagamento direto.
                    </p>
                    <p>
                      <strong>Permissões:</strong> Apenas administradores podem
              ...
              <div className="space-y-6">
                <div className="border rounded-lg p-4 sm:p-6">
                  ...
                  <p className="text-sm text-muted-foreground mb-4">
                    Atualize o cache Redis com todos os dados dos usuários e
                    categorias para melhor performance do sistema.
                  </p>
                  <div className="space-y-4">
                    <div className="flex flex-col sm:flex-row gap-3">
                      ...
                      {preloadResult && (
                        <div className="text-sm text-green-600 flex items-center gap-1">
                          <Users className="h-4 w-4" />
                          {preloadResult.totalUsers} usuários carregados em{" "}
                          {preloadResult.duration}
                        </div>
                      )}
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row gap-3">
                      ...
                      {categoriesResult && (
                        <div className="text-sm text-green-600 flex items-center gap-1">
                          <Tag className="h-4 w-4" />
                          {categoriesResult.totalCategories} categorias e{" "}
                          {categoriesResult.totalPilots} pilotos carregados em{" "}
                          {categoriesResult.duration}
                        </div>
                      )}
                    </div>
                  </div>
                ...
                <div className="border rounded-lg p-4 sm:p-6">
                  ...
                  <p className="text-sm text-muted-foreground mb-4">
                    Configure as taxas do cartão de crédito para cada
                    campeonato, permitindo personalizar os percentuais e taxas
                    fixas por range de parcelas.
                  </p>
                  <Button
