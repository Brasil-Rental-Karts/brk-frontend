    ...
    const processCallback = async () => {
      ...
      if (!code) {
        navigate("/login", {
          ...
          state: {
            error:
              "Código de autorização não recebido do Google. Por favor, tente novamente.",
          },
        });
        return;
      }
      ...
      try {
        ...
        navigate("/login", {
          ...
          state: {
            error:
              "Falha durante o processo de autenticação. Por favor, tente novamente.",
          },
        });
      }
    };
  ...
  return (
    <div className="min-h-screen flex items-center justify-center">
      <div className="bg-card p-6 rounded-lg shadow-md text-center">
        ...
        <p className="mb-4">
          Aguarde enquanto completamos seu login com Google.
        </p>
