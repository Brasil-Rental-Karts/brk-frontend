...
export const championshipParticipationLabels: Record<
...
export const kartExperienceYearsOptions = enumToOptions(
  KartExperienceYears,
  kartExperienceYearsLabels,
);
export const raceFrequencyOptions = enumToOptions(
  RaceFrequency,
  raceFrequencyLabels,
);
export const championshipParticipationOptions = enumToOptions(
  ChampionshipParticipation,
  championshipParticipationLabels,
);
export const competitiveLevelOptions = enumToOptions(
  CompetitiveLevel,
  competitiveLevelLabels,
);
export const attendsEventsOptions = enumToOptions(
  AttendsEvents,
  attendsEventsLabels,
);
export const interestCategoryOptions = enumToOptions(
  InterestCategory,
